...
Maximum amplitude in the envelope
...
Standard deviation of the amplitude sequence
...
Then place the required local input files in data/input/ using the filenames described in docs/WORKFLOW.md.
